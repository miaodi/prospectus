...
\begin{equation}
    u(x,y)=\sin(3\pi{x})^2\sin(3\pi{y})^2,
\end{equation}
...
\begin{figure}[hbt]
    ...
    \end{subfigure}
	\caption{Convergence plot of the best $H^2$ approximation error for non-conforming patch coupling in~\ref{sec:two_patch}.}\label{fig:three_patch_biharmonic_problem}
\end{figure}
